  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in pb-20">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-[#004071] p-6 rounded-[2rem] text-white shadow-xl">
      ...
      <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
        <div className="p-8 border-b border-slate-50 bg-slate-50/50 flex justify-between items-center">
          ...
          <button 
            ...
            className="flex items-center gap-2 bg-[#004071] text-white px-6 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-[#003056] transition-all"
          >
